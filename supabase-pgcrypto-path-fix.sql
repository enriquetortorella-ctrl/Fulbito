...
alter function public.fulbito_register_player(text, text, text, text, text, text, text, text)
  set search_path = public, extensions, pg_temp;
alter function public.fulbito_login_player(text, text, text)
  set search_path = public, extensions, pg_temp;
alter function public.fulbito_update_my_profile(text, text, text, text, text, text, text, text, text)
  set search_path = public, extensions, pg_temp;
alter function public.fulbito_admin_set_player_password(text, text, text)
  set search_path = public, extensions, pg_temp;
